...
# --- 1. Импорт ваших функций из пакета lab5 ---
# Добавляем путь к папке lab5, чтобы Python мог ее найти
# (Это необязательно, если main.py лежит рядом с lab5, но это надежнее)
try:
...
def setup_test_files():
    """
    Создает тестовые JSON и CSV файлы для запуска конвертеров.
    """
...
def main():
    ...
    try:
        ...
        # (Здесь сработает print() ИЗ вашей функции, если вы его добавили)
        ...
        # (Здесь сработает print() ИЗ вашей функции)
