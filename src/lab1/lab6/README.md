...
**CLI для работы с текстом:**
```bash
# Вывод файла с нумерацией строк
python3 src/lab06/cli_text.py cat --input data/samples/people.csv -n

# Анализ частот слов
python3 src/lab06/cli_text.py stats --input data/lab04/input.txt --top 5
```

**CLI для конвертации форматов:**
```bash
# JSON → CSV
python3 src/lab06/cli_convert.py json2csv --in data/samples/people.json --out data/out/result.csv

# CSV → JSON
python3 src/lab06/cli_convert.py csv2json --in data/samples/people.csv --out data/out/result.json

# CSV → XLSX
python3 src/lab06/cli_convert.py csv2xlsx --in data/samples/people.csv --out data/out/result.xlsx
```
